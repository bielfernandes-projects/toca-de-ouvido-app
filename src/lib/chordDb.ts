export const chordDb: Record<string, Record<string, string>> = {
  guitar: {
    ...
    'C7': 'x,3,2,3,1,0', 'C#7': 'x,4,6,4,6,4', 'D7': 'x,x,0,2,1,2', 'D#7': 'x,6,8,6,8,6', 'E7': '0,2,0,1,0,0', 'F7': '1,3,1,2,1,1', 'F#7': '2,4,2,3,2,2', 'Gb7': '2,4,2,3,2,2', 'G7': '3,5,3,4,3,3', 'G#7': '4,6,4,5,4,4', 'Ab7': '4,6,4,5,4,4', 'A7': '5,7,5,6,5,5', 'A#7': '6,8,6,7,6,6', 'Bb7': '6,8,6,7,6,6', 'B7': 'x,2,1,2,0,2',
  ...
  cavaco: {
    ...
    'C7': '2,3,1,2', 'C#7': '3,4,2,3', 'D7': '4,2,1,4', 'D#7': '5,3,2,5', 'E7': '1,1,3,0', 'F7': '1,2,1,3', 'F#7': '2,3,2,4', 'Gb7': '2,3,2,4', 'G7': '3,4,3,5', 'G#7': '4,5,4,6', 'Ab7': '4,5,4,6', 'A7': '5,6,5,7', 'A#7': '6,7,6,8', 'Bb7': '6,7,6,8', 'B7': '4,2,4,4',
